...
public class Rook extends Piece {
    ...
    public Rook(final int piecePossition,final Alliance pieceAllience) {
        super(PieceType.ROOK,piecePossition, pieceAllience,true);
    }
    ...
    public Rook movePiece(Move move) {
        return new Rook(move.getDestinationCoordinate(),move.getMovedPiece().getPieceAllience());
    }
